...
def evaluate(model, tokenizer, labels, pad_token_label_id, text, max_seq_length, model_type, device):
    ...
    eval_dataset = load_and_cache_examples(
        text, tokenizer, labels, pad_token_label_id, max_seq_length, model_type)
...
def predict_tags(text, model_name_or_path, model_type):
    ...
    predictions = evaluate(model, tokenizer, labels, pad_token_label_id,
                           text, max_seq_length, model_type, device)
...
#     model_type = 'distilbert'
#     stuff = predict_tags(text, model_name, model_type)
#     print(stuff)
...
def run():
    ...
    model_name = "Davlan/distilbert-base-multilingual-cased-masakhaner"
    model_type = 'distilbert'
    return predict_tags(text, model_name, model_type)
