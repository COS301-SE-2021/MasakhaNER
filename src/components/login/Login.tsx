    ...
    return (
        <div className = 'login'>
            ...
            <div className = "loginForm">
                <input type="email" id ='email' placeholder = "Email" value={email} onChange={(e) => setEmail(e.target.value)} required /><br/>
                <input type="password" placeholder = 'Password' required/><br/>
                <button  className = 'btn btn-success'  onClick={validate} >Login</button><br/>
