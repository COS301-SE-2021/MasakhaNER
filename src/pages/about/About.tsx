      ...
      <div className="about">
        <div className="out">
          <div className="vision_mission">
            ...
            <p>
              Our mission is to strengthen and spur NLP research in African
              languages, for Africans, by Africans. Despite the fact that 2000
              of the worlds languages are African, Africans are barely
              represented in technology. This has resulted in a technological
              space that does not understand African names, cultures, places or
          ...
          <div className="tool">
            ...
            <p>
              The MasakhaNER Tool is a named entity recognition tool
          ...
          <div className="owners">
            ...
            <p>
              ...
              <a href="https://www.up.ac.za/">University of Pretoria(Tuks)</a>.
